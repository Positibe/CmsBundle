...
namespace Positibe\Bundle\CmsBundle\Cache\Block;
...
CONTENT
            ...
            $dashifiedId,
            $dashifiedId,
            $this->router->generate('positibe_block_js_sync_cache', $keys, true)
        );
    }
...
CONTENT
            ...
            $this->router->generate('positibe_block_js_async_cache', $keys, true)
        );
    }
